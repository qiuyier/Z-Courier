...
Status: in progress. The protocol foundation, shared fixture conformance, and
blocking TCP AUTH/BIND lifecycle are complete. Business sends, downlink
handling, and reconnect remain pending.
