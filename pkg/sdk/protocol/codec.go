...
// Encode serializes a packet using the current Z-Courier wire version.
...
// Decode parses exactly one packet using DefaultMaxBodySize.
func Decode(data []byte) (*Packet, error) {
	return DecodeWithMaxBodySize(data, DefaultMaxBodySize)
}

// DecodeWithMaxBodySize parses exactly one packet and applies maxBodySize.
...
// DecodeReader reads one packet and leaves subsequent bytes in reader.
